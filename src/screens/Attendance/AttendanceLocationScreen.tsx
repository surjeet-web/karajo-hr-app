...
export const AttendanceLocationScreen: React.FC<any> = ({ navigation }) => {
  const insets = useSafeAreaInsets();
  const [gpsStatus, setGpsStatus] = useState<string>('searching');
  const [gpsAccuracy, setGpsAccuracy] = useState<any>(null);
