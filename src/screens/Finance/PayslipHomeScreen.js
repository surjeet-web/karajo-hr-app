...
export const PayslipHomeScreen = ({ navigation }) => {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.historyList}>
          {payroll.payslips.map((item) => (
            <TouchableOpacity key={item.id} style={styles.historyItem} onPress={() => navigation.navigate('ExpenseDetail', { payslip: item })}>
        ...
        {payroll.taxDocuments.map(doc => (
          <Card key={doc.id} style={styles.taxCard} padding="md">
