...
export const OvertimeSuccessScreen = ({ navigation }) => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <View style={styles.summaryCard}>
          <View style={styles.summaryItem}>
            ...
            <View>
              ...
              <Text style={styles.summaryValue}>Fri, Oct 20, 2026.</Text>
            </View>
          </View>
          ...
          <View style={styles.summaryItem}>
            ...
            <View>
              ...
              <Text style={styles.summaryValue}>3h 15m</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={styles.footer}>
        <Button title="Back to permission" onPress={() => navigation.navigate('OvertimeHome')} />
        <Button title="Go to approval" variant="outline" onPress={() => navigation.navigate('OvertimeHome')} style={styles.secondaryButton} />
      </View>
    </View>
  );
};
